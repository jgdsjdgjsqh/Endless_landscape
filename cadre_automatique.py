...
def deplacement_automatique_x_y(bord_atteint, temps, pos, pos_reel, sens_deplacement, vitesse, limite_up,
                                size, bord_atteint_debut, temps_min, temps_max, debut_bord, temps_restant_bord):
    if not bord_atteint:
    ...
    if bord_atteint:
        ...
        if duree_bord_atteint > temps_restant_bord:
            ...
            temps = time.time()
    return pos, pos_reel, temps, sens_deplacement, bord_atteint, bord_atteint_debut, debut_bord, temps_restant_bord
